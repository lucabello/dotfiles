...
PanelWindow {
    ...
    readonly property bool disableAnimations: config.notifications.disableAnimations

    function anim(ms) {
        return disableAnimations ? 0 : ms
    }
    ...
    WlrLayershell.namespace: "NotificationPopups"
        ...
        Repeater {
            ...
            Item {
                ...
                SequentialAnimation {
                    ...
                    // Minimal stagger
                    PauseAnimation { duration: anim(notifCard.index * 10) }
