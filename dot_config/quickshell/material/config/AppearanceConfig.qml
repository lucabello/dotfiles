...
QtObject {
    ...
    // Centralized UI text tokens (use across bar, control center, OSD)
    readonly property var ui: QtObject {
        property string family: "Inter"
        property int textXs: 10
        property int textSm: 12
        property int textMd: 13
        property int textLg: 14
        property int textXl: 16
    ...
    // Centralized icon font tokens
    readonly property var icons: QtObject {
        property string family: "Material Design Icons"
        property int xs: 14
        property int s: 16
        property int m: 20
        property int l: 22
