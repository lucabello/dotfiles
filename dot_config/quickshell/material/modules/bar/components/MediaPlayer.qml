...
Item {
    ...
    readonly property real componentScale: QsConfig.Config.barComponents.scale.media
    implicitWidth: (hasPlayer ? contentRow.implicitWidth : 70) * componentScale
    implicitHeight: 22 * componentScale
    ...
    RowLayout {
        ...
        Rectangle {
            ...
            gradient: Gradient {
                ...
                GradientStop { position: 0.3; color: Qt.rgba(barColors.foreground.r, barColors.foreground.g, barColors.foreground.b, 0.2) }
                GradientStop { position: 0.7; color: Qt.rgba(barColors.foreground.r, barColors.foreground.g, barColors.foreground.b, 0.2) }
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                Layout.preferredHeight: 20
                radius: 10
                color: prevArea.containsMouse ? Qt.rgba(barColors.foreground.r, barColors.foreground.g, barColors.foreground.b, 0.15) : "transparent"
                ...
                Text {
                    ...
                    font.family: "Material Design Icons"
                    font.pixelSize: 13
                    color: prevArea.containsMouse ? barColors.primary : barColors.foreground
            ...
            Rectangle {
                ...
                gradient: Gradient {
                    GradientStop { position: 0.0; color: Qt.lighter(barColors.primary, playArea.containsMouse ? 1.15 : 1.0) }
                    GradientStop { position: 1.0; color: Qt.darker(barColors.primary, playArea.containsMouse ? 1.0 : 1.1) }
                }
                ...
                Rectangle {
                    ...
                    color: "transparent"
                    border.width: 2
                    border.color: Qt.rgba(barColors.primary.r, barColors.primary.g, barColors.primary.b, playArea.containsMouse ? 0.3 : 0)
                    z: -1
            ...
            Rectangle {
                ...
                Layout.preferredHeight: 20
                radius: 10
                color: nextArea.containsMouse ? Qt.rgba(barColors.foreground.r, barColors.foreground.g, barColors.foreground.b, 0.15) : "transparent"
                ...
                Text {
                    ...
                    font.family: "Material Design Icons"
                    font.pixelSize: 13
                    color: nextArea.containsMouse ? barColors.primary : barColors.foreground
        ...
        Item {
            ...
            Rectangle {
                anchors.fill: parent
                radius: 2
                color: Qt.rgba(barColors.foreground.r, barColors.foreground.g, barColors.foreground.b, 0.12)
                ...
                Rectangle {
                    ...
                    gradient: Gradient {
                        ...
                        GradientStop { position: 0.0; color: Qt.darker(barColors.primary, 1.2) }
                        GradientStop { position: 1.0; color: barColors.primary }
                    }
