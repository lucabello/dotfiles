...
Rectangle {
    ...
    color: {
        ...
        if (isOccupied) return Qt.rgba(barColors.foreground.r, barColors.foreground.g, barColors.foreground.b, 0.5)
        return Qt.rgba(barColors.foreground.r, barColors.foreground.g, barColors.foreground.b, 0.2)
    }
    ...
    Rectangle {
        ...
        color: "transparent"
        border.width: 2
        border.color: Qt.rgba(barColors.primary.r, barColors.primary.g, barColors.primary.b, 0.15)
    ...
    Rectangle {
        ...
        height: 18
        radius: 4
        color: Qt.rgba(barColors.surfaceContainerHigh.r, barColors.surfaceContainerHigh.g, barColors.surfaceContainerHigh.b, 0.95)
        border.width: 1
        border.color: Qt.rgba(barColors.foreground.r, barColors.foreground.g, barColors.foreground.b, 0.1)
