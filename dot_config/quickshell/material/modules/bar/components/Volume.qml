...
Item {
    ...
    readonly property real componentScale: QsConfig.Config.barComponents.scale.volume
    readonly property bool isHovered: mouseArea.containsMouse
    readonly property bool isMuted: volumeMonitor.muted
    readonly property int percentage: volumeMonitor.percentage
    
    implicitWidth: volumeRow.implicitWidth * componentScale
    ...
    RowLayout {
        ...
        Text {
            ...
            color: {
                if (isMuted) return barColors.textDisabled
