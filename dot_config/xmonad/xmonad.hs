...
-- import XMonad.Hooks.DynamicProperty as DynamicProperty
...
-- myEventHook = swallowEventHook (className =? "alacritty") (return True) <> DynamicProperty.dynamicPropertyChange "WM_NAME" myManageHook <> Hacks.windowedFullscreenFixEventHook
